...
public class FeatureListPackageImpl extends EPackageImpl implements FeatureListPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link FeatureListPackage#eINSTANCE} when that field is accessed.
	...
	public static FeatureListPackage init() {
		if (isInited) return (FeatureListPackage)EPackage.Registry.INSTANCE.getEPackage(FeatureListPackage.eNS_URI);

		// Obtain or create and register package
		FeatureListPackageImpl theFeatureListPackage = (FeatureListPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FeatureListPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FeatureListPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFeatureList_ExternalFeatureModelURI(), ecorePackage.getEString(), "externalFeatureModelURI", null, 0, 1, FeatureList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeatureList_OwnedFeatures(), this.getFeature(), null, "ownedFeatures", null, 0, -1, FeatureList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeatureList_ArtefactModel(), theArtefactModelPackage.getArtefactModel(), null, "artefactModel", null, 0, 1, FeatureList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
