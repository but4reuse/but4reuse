 ...
 * <ul>
 *   <li>{@link org.but4reuse.featurelist.impl.FeatureListImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.but4reuse.featurelist.impl.FeatureListImpl#getExternalFeatureModelURI <em>External Feature Model URI</em>}</li>
 *   <li>{@link org.but4reuse.featurelist.impl.FeatureListImpl#getOwnedFeatures <em>Owned Features</em>}</li>
 *   <li>{@link org.but4reuse.featurelist.impl.FeatureListImpl#getArtefactModel <em>Artefact Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureListImpl extends MinimalEObjectImpl.Container implements FeatureList {
	...
	/**
	 * The default value of the '{@link #getExternalFeatureModelURI() <em>External Feature Model URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getExternalFeatureModelURI() <em>External Feature Model URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getExternalFeatureModelURI()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getArtefactModel() <em>Artefact Model</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setExternalFeatureModelURI(String newExternalFeatureModelURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureListPackage.FEATURE_LIST__EXTERNAL_FEATURE_MODEL_URI, oldExternalFeatureModelURI, externalFeatureModelURI));
	}
	...
	public EList<Feature> getOwnedFeatures() {
		if (ownedFeatures == null) {
			ownedFeatures = new EObjectContainmentEList<Feature>(Feature.class, this, FeatureListPackage.FEATURE_LIST__OWNED_FEATURES);
		}
	...
	public ArtefactModel getArtefactModel() {
		if (artefactModel != null && artefactModel.eIsProxy()) {
			...
			if (artefactModel != oldArtefactModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureListPackage.FEATURE_LIST__ARTEFACT_MODEL, oldArtefactModel, artefactModel));
			}
		}
	...
	public void setArtefactModel(ArtefactModel newArtefactModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureListPackage.FEATURE_LIST__ARTEFACT_MODEL, oldArtefactModel, artefactModel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FeatureListPackage.FEATURE_LIST__ARTEFACT_MODEL:
				if (resolve) return getArtefactModel();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FeatureListPackage.FEATURE_LIST__EXTERNAL_FEATURE_MODEL_URI:
				return EXTERNAL_FEATURE_MODEL_URI_EDEFAULT == null ? externalFeatureModelURI != null : !EXTERNAL_FEATURE_MODEL_URI_EDEFAULT.equals(externalFeatureModelURI);
			case FeatureListPackage.FEATURE_LIST__OWNED_FEATURES:
