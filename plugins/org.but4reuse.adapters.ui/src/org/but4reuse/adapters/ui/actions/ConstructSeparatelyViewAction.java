...
/**
 * Construction separately action TODO: Refactor with construction action
 * 
 * @author jabier.martinez
 */
public class ConstructSeparatelyViewAction implements IViewActionDelegate {
						...
						progressDialog.run(true, true, new IRunnableWithProgress() {
							...
							public void run(IProgressMonitor monitor)
								...
								for (String key : adaptersMap.keySet()) {
									...
									adap.construct(blockConstructionURI, elementsMapByAdapter.get(key), monitor);
									monitor.worked(1);
								}
