 ...
 * @generated
 */
public class AdaptedModelActionBarContributor extends EditingDomainActionBarContributor implements
	...
	protected IAction showPropertiesViewAction = new Action(
			AdaptedModelEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			AdaptedModelEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				AdaptedModelEditorPlugin.INSTANCE.getString("_UI_AdaptedModelEditor_menu"),
				"org.but4reuse.adaptedmodelMenuID");
		...
		createChildMenuManager = new MenuManager(
				AdaptedModelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				AdaptedModelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
