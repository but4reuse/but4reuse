 ...
 * @generated
 */
public class FeatureListActionBarContributor extends EditingDomainActionBarContributor implements
	...
	protected IAction showPropertiesViewAction = new Action(
			FeatureListEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			FeatureListEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				FeatureListEditorPlugin.INSTANCE.getString("_UI_FeatureListEditor_menu"),
				"org.but4reuse.featurelistMenuID");
		...
		createChildMenuManager = new MenuManager(
				FeatureListEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				FeatureListEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
