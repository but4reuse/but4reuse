...
/**
 * This class contains the C++ element implementation for a #ifdef directive
 * Example : #ifdef RECTANGULAR super_function();
 * 
 * @author sandu.postaru
 */

public class IfdefDirective extends CppElement {

	public IfdefDirective(IASTNode node, CppElement parent, String text, String rawText) {
		super(node, parent, text, rawText, CppElementType.IFDEF_DIR);
	}
