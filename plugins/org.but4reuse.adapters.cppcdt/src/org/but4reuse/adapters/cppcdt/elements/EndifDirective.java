...
/**
 * This class contains the C++ element implementation for a #endif directive
 * Example : #endif
 * 
 * @author jabier.martinez
 */

public class EndifDirective extends CppElement {

	public EndifDirective(IASTNode node, CppElement parent, String text, String rawText) {
		super(node, parent, text, rawText, CppElementType.ENDIF_DIR);
	}
