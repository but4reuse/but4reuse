...
/**
 * This is the item provider adapter for a {@link org.but4reuse.artefactmodel.adaptedmodel.ElementWrapper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementWrapper_element_feature", "_UI_ElementWrapper_type"),
				 AdaptedModelPackage.Literals.ELEMENT_WRAPPER__ELEMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementWrapper_blockElements_feature", "_UI_ElementWrapper_type"),
				 AdaptedModelPackage.Literals.ELEMENT_WRAPPER__BLOCK_ELEMENTS,
				 true,
				 false,
				 true,
				 null,
