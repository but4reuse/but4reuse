...
/**
 * Credits to: https://github.com/rrice/java-string-similarity Ralph Allan Rice
 * 
 * A strategy that uses the Levenshtein's Distance to calculate the <i>edit
 * distance</i> of two strings. Then it converts this to a "score" to fit the
 * framework.
 * 
