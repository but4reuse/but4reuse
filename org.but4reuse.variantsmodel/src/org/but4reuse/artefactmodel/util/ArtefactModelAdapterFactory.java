...
public class ArtefactModelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ArtefactModelSwitch<Adapter> modelSwitch =
		new ArtefactModelSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.but4reuse.artefactmodel.ArtefactModel <em>Artefact Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.but4reuse.artefactmodel.Artefact <em>Artefact</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.but4reuse.artefactmodel.ComposedArtefact <em>Composed Artefact</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
