 ...
 * <ul>
 *   <li>{@link org.but4reuse.adaptedmodel.BlockElement#getElementWrappers <em>Element Wrappers</em>}</li>
 * </ul>
 * </p>
 *
...
public interface BlockElement extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link org.but4reuse.adaptedmodel.ElementWrapper#getBlockElements <em>Block Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
