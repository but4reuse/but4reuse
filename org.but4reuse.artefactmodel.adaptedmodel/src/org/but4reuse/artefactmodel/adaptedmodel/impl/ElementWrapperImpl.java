 ...
 * <ul>
 *   <li>{@link org.but4reuse.artefactmodel.adaptedmodel.impl.ElementWrapperImpl#getElement <em>Element</em>}</li>
 *   <li>{@link org.but4reuse.artefactmodel.adaptedmodel.impl.ElementWrapperImpl#getBlockElements <em>Block Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementWrapperImpl extends MinimalEObjectImpl.Container implements ElementWrapper {
	...
	/**
	 * The cached value of the '{@link #getBlockElements() <em>Block Elements</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setElement(Object newElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptedModelPackage.ELEMENT_WRAPPER__ELEMENT, oldElement, element));
	}
	...
	public EList<BlockElement> getBlockElements() {
		if (blockElements == null) {
			blockElements = new EObjectWithInverseResolvingEList.ManyInverse<BlockElement>(BlockElement.class, this, AdaptedModelPackage.ELEMENT_WRAPPER__BLOCK_ELEMENTS, AdaptedModelPackage.BLOCK_ELEMENT__ELEMENT_WRAPPERS);
		}
