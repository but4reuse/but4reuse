...
import org.but4reuse.artefactmodel.adaptedmodel.AdaptedArtefact;
import org.but4reuse.artefactmodel.adaptedmodel.AdaptedModel;
...
import org.but4reuse.artefactmodel.adaptedmodel.ElementWrapper;
...
public class AdaptedModelPackageImpl extends EPackageImpl implements AdaptedModelPackage {
	 ...
	 * @see org.but4reuse.artefactmodel.adaptedmodel.AdaptedModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link AdaptedModelPackage#eINSTANCE} when that field is accessed.
	...
	public static AdaptedModelPackage init() {
		if (isInited) return (AdaptedModelPackage)EPackage.Registry.INSTANCE.getEPackage(AdaptedModelPackage.eNS_URI);

		// Obtain or create and register package
		AdaptedModelPackageImpl theAdaptedModelPackage = (AdaptedModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AdaptedModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AdaptedModelPackageImpl());
	...
	public void initializePackageContents() {
		...
		ArtefactModelPackage theArtefactModelPackage = (ArtefactModelPackage)EPackage.Registry.INSTANCE.getEPackage(ArtefactModelPackage.eNS_URI);
		FeatureListPackage theFeatureListPackage = (FeatureListPackage)EPackage.Registry.INSTANCE.getEPackage(FeatureListPackage.eNS_URI);
		...
		initEReference(getElementWrapper_BlockElements(), this.getBlockElement(), this.getBlockElement_ElementWrappers(), "blockElements", null, 0, -1, ElementWrapper.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
