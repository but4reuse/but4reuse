 ...
 * <ul>
 *   <li>{@link org.but4reuse.artefactmodel.adaptedmodel.impl.BlockElementImpl#getElementWrappers <em>Element Wrappers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockElementImpl extends MinimalEObjectImpl.Container implements BlockElement {
	/**
	 * The cached value of the '{@link #getElementWrappers() <em>Element Wrappers</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ElementWrapper> getElementWrappers() {
		if (elementWrappers == null) {
			elementWrappers = new EObjectWithInverseResolvingEList.ManyInverse<ElementWrapper>(ElementWrapper.class, this, AdaptedModelPackage.BLOCK_ELEMENT__ELEMENT_WRAPPERS, AdaptedModelPackage.ELEMENT_WRAPPER__BLOCK_ELEMENTS);
		}
